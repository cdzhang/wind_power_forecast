...
def prep_env():
    ...
    """
    args = {
        "model_file_name": 'RNNETMP_hh_HH_hidsz1_HIDSZ1_hidsz2_HIDSZ2_out_OUT_pd_PARTIAL_DATA_attn_ATTN',   
        ...
        "output_len": OUT,
        'partial_data': PARTIAL_DATA, #None, #171,
        'output_attention': ATTN,
        ## fintune
        'finetune': True,
        'finetune_epochs': 2,
        ...
        ### scaler
        'divide_by_max_patv': True, # whether patv should be divided by max_patv
        'max_patv': 1521.6,  
        'scale_method': 'multi_scaler',
        'adaptive_norm': False,
        'lstm_dec_lookbk': 6, # lstm decoder input is the history mean of lstm_dec_lookbk
        
        'more_median_cols': ['w_angle_sin', 'w_angle_cos'], # more median cols to calculate
