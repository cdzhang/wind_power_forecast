...
def prep_env():
    ...
    """
    args = {
        "model_file_name": 'RNN_multiple_FFFF',  
        'model_dir': 'paddlepaddle',
        'paddlepaddle_model': 'RNN_multiple', 
        "ensemble_preps": ENSEMBLE_LIST,
       'final_adjust': False,
        ...
        'more_median_cols': ['w_angle_sin', 'w_angle_cos'], 
        ...
        'shift_time_based_on_Etmp': False, 
        'fill_unknown_method': 'interpolate',  
