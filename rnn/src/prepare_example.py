...
def prep_env():
    ...
    """
    args = {
        "model_file_name": 'rnn_example',   # model saved in working_dir/checkpoints/model_file_name
        ...
        "location_file": "/home/notebook/data/group/intention_rec/TimeSeries/KDD2022/sdwpf_baidukddcup2022_turb_location.CSV",        # location file
